...
const CTX: IngressContext = { team_uuid: "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa", plan_level: "pro", stamped_by: "nano-agent.platform.ingress@v1" };
const HEADER = { schema_version: "1.0.0", message_uuid: "11111111-1111-1111-1111-111111111111", message_type: "session.start", delivery_kind: "command" as const, sent_at: "2026-04-16T00:00:00.000+00:00", producer_role: "client" as const, producer_id: "nano-agent.client.cli@v1", priority: "normal" as const };
const TRACE = { trace_id: "11111111-1111-1111-1111-111111111111", session_uuid: "22222222-2222-2222-2222-222222222222" };
...
describe("normalizeClientFrame", () => {
  it("stamps authority from ingress context", () => {
    ...
    expect(result.authority.stamped_by).toBe(CTX.stamped_by);
    expect(result.session_frame.stream_id).toBe("main");
  });

  it("rejects client frame that includes authority (forged)", () => {
    const frame: NacpClientFrame = {
      header: HEADER, trace: TRACE, body: {},
      authority: { team_uuid: "fake", plan_level: "pro", stamped_by: "evil@v1", stamped_at: "2026-01-01T00:00:00Z" },
    };
