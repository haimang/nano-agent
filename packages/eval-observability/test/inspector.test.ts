 ...
 *
 * Covers:
 *  - Canonical catalog enforcement (unknown kinds are rejected).
 ...
 *  - Catalog drift guard: the local catalog stays aligned with
...
// drift between the inspector's local catalog and nacp-session truth.
...
describe("SessionInspector", () => {
  ...
  describe("catalog alignment", () => {
    it("mirrors the canonical kinds exported by @haimang/nacp-session", () => {
