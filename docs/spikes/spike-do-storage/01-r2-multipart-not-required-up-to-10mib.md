...
| 跑 large=true probe 验证 50 MiB / 100 MiB 边界 | Phase 6 round 2 integrated | `spikes/round-1-bare-metal/spike-do-storage/` re-run with `{"large":true}` | spike runner |
...
- `spikes/round-1-bare-metal/spike-do-storage/src/probes/r2-multipart.ts`
- 输出：`spikes/round-1-bare-metal/spike-do-storage/.out/2026-04-19T08-17-46Z.json`
