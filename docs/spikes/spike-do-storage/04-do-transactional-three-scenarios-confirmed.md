...
- `spikes/round-1-bare-metal/spike-do-storage/src/probes/do-transactional.ts`
- `spikes/round-1-bare-metal/spike-do-storage/src/do/ProbeDO.ts` (handleTransactionProbe)
...
> **Driver**: `spikes/round-2-integrated/spike-do-storage-r2/src/re-validation/storage.ts` via
