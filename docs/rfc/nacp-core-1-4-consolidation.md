...
1. `pnpm --filter @nano-agent/nacp-core typecheck build test` → `259/259` tests passed
2. `pnpm --filter @nano-agent/nacp-session typecheck build test` → `119/119` tests passed
