...
| `nano_session_activity_logs` | `activity_uuid, team_uuid, conversation_uuid, session_uuid, turn_uuid, trace_uuid, event_kind, payload_json, occurred_at` | shared append-only by owner event source |
...
- `nano_session_activity_logs(team_uuid, occurred_at desc)`
- `nano_session_activity_logs(trace_uuid)`
