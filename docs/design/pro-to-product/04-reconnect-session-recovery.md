...
|----------------|------|----------|----------|------|----------|
| D-04-1 | PP3 是否承诺 exactly-once replay？ | PP3/PP6 | 否 | frozen | `docs/design/pro-to-product/PPX-qna.md` Q12 |
...
| D-04-3 | replay gap 是否允许 silent latest-state fallback？ | PP3 | 否，必须 degraded | frozen | `docs/design/pro-to-product/PPX-qna.md` Q14 |
