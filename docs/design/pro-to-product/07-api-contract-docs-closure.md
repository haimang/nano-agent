...
| D-07-2 | docs closure 是否要求功能 fully complete？ | PP6 | 否，要求 truthful readiness | frozen | `docs/design/pro-to-product/PPX-qna.md` Q21 |
| D-07-3 | 是否引入 OpenAPI generator？ | PP6 | 否 | frozen | `docs/design/pro-to-product/PPX-qna.md` Q22 |
