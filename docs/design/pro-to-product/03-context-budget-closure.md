...
| D-03-2 | auto compact 未接线时是否可写 live？ | PP2/PP6 | 否 | proposed | 本设计 + `docs/design/pro-to-product/PPX-qna.md` Q10 |
| D-03-3 | PP2 是否必须引入 LLM summary？ | PP2 | 否，先 truth/boundary | proposed | 本设计 + `docs/design/pro-to-product/PPX-qna.md` Q11 |
