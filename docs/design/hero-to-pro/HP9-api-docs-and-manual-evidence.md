...
| `HP9-D3` | prod schema baseline 是否可只依赖仓内 migrations？ | HP9 / HP10 | 否；必须 remote/prod 校对 | `frozen` | `workers/orchestrator-core/wrangler.jsonc:33-41,90-97` |
| `HP9-D4` | 18 份 docs 是否全部走同样强度 review？ | HP9 / reviewers | 否；rewrite/new 深审，稳定 docs sanity check | `frozen` | 当前文档成熟度明显不均：`clients/api-docs/error-index.md:1-12`, `clients/api-docs/session.md:1-27` |
