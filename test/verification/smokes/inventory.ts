...
export const SMOKE_INVENTORY: readonly SmokeCase[] = [
  // ── L0 — pre-existing E2E carried forward ──────────────────────
  {
    ...
    profileId: "local-l0",
    source: "test/e2e/e2e-05-session-resume.test.mjs",
  ...
  },
  {
    ...
    requiredness: "required",
    profileId: "local-l0",
    source: "test/e2e/e2e-06-cancel-midturn.test.mjs",
  ...
  },
  {
    ...
    requiredness: "required",
    profileId: "local-l0",
    source: "test/e2e/e2e-09-observability-pipeline.test.mjs",
  ...
  },
  {
    ...
    requiredness: "required",
    profileId: "local-l0",
    source: "test/e2e/e2e-11-ws-replay-http-fallback.test.mjs",
  ...
  },
  {
    ...
    requiredness: "required",
    profileId: "local-l0",
    source: "test/e2e/e2e-13-content-replacement-consistency.test.mjs",
  ...
  },
  {
    ...
    requiredness: "required",
    profileId: "local-l0",
    source: "test/e2e/e2e-14-hooks-resume.test.mjs",
  ...
  // ── L1 — deploy-shaped dry-run smoke ───────────────────────────
  {
    ...
    source: "test/verification/smokes/l1-session-edge.smoke.ts",
  ...
  },
  {
    ...
    requiredness: "required",
    profileId: "remote-dev-l1",
    source: "test/verification/smokes/l1-external-seams.smoke.ts",
  ...
  // ── L2 — real-boundary smoke ───────────────────────────────────
  {
    ...
    source: "test/verification/smokes/l2-real-provider.smoke.ts",
