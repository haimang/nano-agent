 ...
 *
 * Strictly consumes the 13 canonical `session.stream.event` kinds defined
...
/**
 * The 13 canonical `session.stream.event` kinds.
 *
 * HP6 P3 added `tool.call.cancelled` (Q21).
 * HP7 P4-02 added `session.fork.created` (Q23).
 * HP2-D2 (deferred-closure absorb) added `model.fallback`.
 *
...
/** Returns true iff `kind` is one of the 13 canonical kinds. */
